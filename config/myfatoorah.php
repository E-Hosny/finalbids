...
//     'test_mode'    => env('MYFATOORAH_TEST_MODE'),
//     'country_iso'  => env('MYFATOORAH_COUNTRY_ISO'),
//     'currency'     => 'SAR', // O el código de moneda que desees utilizar
// ];
...
return [
    ...
    'test_mode'            => env('MYFATOORAH_TEST_MODE'),
    'country_iso'          => env('MYFATOORAH_COUNTRY_ISO'),
    'live_payment_url'     => env('MYFATOORAH_LIVE_PAYMENT_URL'),
    'test_payment_url'     => env('MYFATOORAH_TEST_PAYMENT_URL'),
    'currency'             => env('MYFATOORAH_CURRENCY'),
    'countrycode'             => env('MYFATOORAH_COUNTRYCODE'),
];