<x-admin-layout>
    <main class="main-content position-relative border-radius-lg ">
        @include('admin.include.navbar', ['module' => 'Language', 'link' => 'admin.language.index', 'page' => ''])
    ...
    $(document).ready(function() {
        if ($.fn.dataTable.isDataTable('#languages-table')) {
            var data = $('#languages-table').DataTable();
        } else {
            var data = $('#languages-table').DataTable({
                paging: false
            });
