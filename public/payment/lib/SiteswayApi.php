...
class SiteswayApi {
	...
	public function __construct($brandId, $apiKey, $base = 'https://gate.sitesway.sa/api/v1/', $config = []) {
	...
	/**
	 * 
	 * @param \Sitesway\Model\Purchase $purchase
	 * @return \Sitesway\Model\Purchase
	 */
